...
integer,parameter :: col=400 !題庫數
integer,parameter :: length=10 !作答題長
...
do i=1,row !10000
	write(114,"(I5,20F10.4)") i,(thetaHAT(i,j),j=1,length)
end do

!------------------
!寫下作答反應
open(115,file="summery_CAT_respones.txt",status="replace")
write(115,"(A5,20I3)") "ID",(i,i=1,length)
do i=1,row !10000
	write(115,"(I5,20I3)") i,(resp(i,j),j=1,length)
end do

!------------------
!寫下所選的試題難度
open(116,file="summery_CAT_item.txt",status="replace")
write(116,"(A5,20I10)") "ID",(i,i=1,length)
do i=1,row !10000
	write(116,"(I5,20I10)") i,(place_choose(i,j),j=1,length)
end do

!write(116,"(A5,A5,20I10)") "type","ID",(i,i=1,length)
!do i=1,row !10000
!	write(116,"(A5,I5,20F10.4)") "a",i,(a_choose(i,j),j=1,length)
!	write(116,"(A5,I5,20F10.4)") "b",i,(b_choose(i,j),j=1,length)
!	write(116,"(A5,I5,20F10.4)") "c",i,(c_choose(i,j),j=1,length)
!end do
