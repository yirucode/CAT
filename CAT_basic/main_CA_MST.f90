program CA_MST
    ...
    ! === given data ====
    ! === 輸入資料設定 ===
    character(len = 50), parameter :: dataPath = "data/parameter_MST_len20.txt" !parameter_MST_len5.txt
    character(len = 50), parameter :: dataPath2 = "data/Population_Uniform.txt"  !Normal Uniform
    ! === MST set ===
    integer,parameter :: numStages = 2 !4 2 
    integer,parameter :: maxLevel = 3 !3
    integer, parameter :: numModuleInLevel = 5 !20 10
    integer, parameter :: maxModule = maxLevel*numModuleInLevel
    integer, parameter :: numItemInModule = 20 !5 10
    ! === parameter ===
    ...
    write(unit = 100, fmt = '(A10,A)') "method = ", " CA_MST"
