...
library(readxl)
MST_data <- read_excel("D:/CAT_inGit/CAT_in_R/data/MST_data.xlsx", sheet = "stage2")
View(MST_data)
#設定排序
...
# PNG 輸出，單位為像素
png( file = "D:/CAT_inGit/CAT_in_R/picture/stage2_Bias.png", width = 800, height = 450)
plot(p)
dev.off()
...
# PNG 輸出，單位為像素
png( file = "D:/CAT_inGit/CAT_in_R/picture/stage2_RMSE.png", width = 800, height = 450)
plot(p)
dev.off()
...
# PNG 輸出，單位為像素
png( file = "D:/CAT_inGit/CAT_in_R/picture/stage2_PsiMax.png", width = 800, height = 450)
plot(p)
dev.off()
...
# PNG 輸出，單位為像素
png( file = "D:/CAT_inGit/CAT_in_R/picture/stage2_pooluseRate.png", width = 800, height = 450)
plot(p)
dev.off()
...
# PNG 輸出，單位為像素
png( file = "D:/CAT_inGit/CAT_in_R/picture/stage2_InforTurth.png", width = 800, height = 450)
plot(p)
dev.off()
...
# PNG 輸出，單位為像素
png( file = "D:/CAT_inGit/CAT_in_R/picture/stage2_InforEstimate.png", width = 800, height = 450)
plot(p)
dev.off()
