...
MST_data$method <- factor(MST_data$method, levels = c("CAT+Psi&con", "CA-MST+Psi", "OMST+cont.Psi","MST有平行"))
#繪圖
library(ggplot2)
...
# PNG 輸出，單位為像素
png( file = "D:/CAT_inGit/CAT_in_R/picture/len40_Bias.png", width = 600, height = 600)
plot(p)
dev.off()
...
# PNG 輸出，單位為像素
png( file = "D:/CAT_inGit/CAT_in_R/picture/len40_RMSE.png", width = 600, height = 600)
plot(p)
dev.off()
...
# PNG 輸出，單位為像素
png( file = "D:/CAT_inGit/CAT_in_R/picture/len40_PsiMax.png", width = 600, height = 600)
plot(p)
dev.off()
...
# PNG 輸出，單位為像素
png( file = "D:/CAT_inGit/CAT_in_R/picture/len40_pooluseRate.png", width = 600, height = 600)
plot(p)
dev.off()
...
# PNG 輸出，單位為像素
png( file = "D:/CAT_inGit/CAT_in_R/picture/len40_InforTurth.png", width = 600, height = 600)
plot(p)
dev.off()
...
# PNG 輸出，單位為像素
png( file = "D:/CAT_inGit/CAT_in_R/picture/len40_InforEstimate.png", width = 600, height = 600)
plot(p)
dev.off()
